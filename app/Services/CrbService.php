...
class CrbService {
    ...
    //contact crb for detail verification
		...
		if($crb_meta_data["crb_responsecode"]==200){//request successfull
    ...
    public function checkBalance(){
		$username="cX26K2W836QT8Up";//crb username
		$password="D57Jc8SdsSJ1gAE";//crb password
		...
		$ch = curl_init('https://secure3.transunionafrica.com/crbws/ke');
		curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
		curl_setopt($ch, CURLOPT_VERBOSE, 0);       
		curl_setopt($ch, CURLOPT_USERPWD, "$username:$password");
