...
return [
    ...
    */
    ...
    'transactionStatus' =>[
        ...
        'pending' => 1,//transaction still pending
        'failed' => 2,//transaction failed
    ],
     'customerStatus' =>[
        'new' => 0,//New customer, cannot borrow
        'active' => 1,//Active customer, can borrow
        'suspended' => 2,//Suspended customer, cannot borrow
        'deleted' => 3,//Deleted customer, cannot borrow
