            ...
            <div class="col-md-10">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('/admin/screens/create') }}" class="btn btn-success btn-sm" title="Add New Screen">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/screens', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Title</th><th>Message</th><th>Icon</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <div class="pagination-wrapper"> {!! $screens->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
