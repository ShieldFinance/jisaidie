        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="panel panel-default">
                    <div class="panel-heading">Responsetemplates</div>
                    <div class="panel-body">
                        <a href="{{ url('/admin/response-templates/create') }}" class="btn btn-success btn-sm" title="Add New ResponseTemplate">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/response-templates', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $responsetemplates->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
