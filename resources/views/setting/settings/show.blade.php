                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Setting Name </th><td> {{ $setting->setting_name }} </td></tr><tr><th> Setting Value </th><td> {{ $setting->setting_value }} </td></tr><tr><th> Setting Description </th><td> {{ $setting->setting_description }} </td></tr>
                                </tbody>
                            </table>
                        </div>
